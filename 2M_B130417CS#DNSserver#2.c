...
main()
{
        ...
        char data[1024],datar[1024],wrd[100],ch1[50],ch2[50],ch[1],un[50],pw[50],data2[1024],output[1024],ch3[50],dataw[1024];
        ...
        local_server.sin_port = htons(8881);
        local_server.sin_addr.s_addr = inet_addr("127.0.0.10");
